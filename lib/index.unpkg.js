...
__webpack_require__.d(__webpack_exports__, {
  "rU": () => (/* reexport */ huxy_router_link_0),
  "cb": () => (/* binding */ emitRoute),
  "Bv": () => (/* binding */ getRoute),
...
/* harmony default export */ const utils_fixRoute = (fixRoute);
...
/* harmony default export */ const src_formatMenu = (formatMenu);
...
/* harmony default export */ const utils_params2str = (params2str);
...
/* harmony default export */ const utils_getParams = (getParams);
...
const handleRouterChange = (opt, basepath, browserRouter, localPath) => {
  ...
  path = fixFullpath(basepath, path, browserRouter, opt?.exact);
...
/* harmony default export */ const utils_eventBus = (eventBus_eventBus);
...
/* harmony default export */ const utils_createContainer = (createContainer_createContainer);
...
/* harmony default export */ const utils_store = (store_store);
...
/* harmony default export */ const loadCompData = (LoadCompData);
...
const wrap = ({ Loading, ErrorBoundary, loadedComp }) => {
  const suspend = /* @__PURE__ */ (0,jsx_runtime.jsx)(external_react_.Suspense, { fallback: handleLoading(Loading), children: loadedComp });
...
/* harmony default export */ const src_wrapComponent = (wrapComponent);
...
const handleChild = (Comp, routerProps, children, compKey) => {
  if (utils_isAsync(children)) {
    return children.then((res) => src_wrapComponent({ Comp, routerProps, children: res.default ?? res }));
  }
...
/* harmony default export */ const src_loadComps = (loadComps);
...
const useRouter = (initState) => {
  const [input, setInput] = (0,external_react_.useState)(initState);
  const [output, setOutput] = (0,external_react_.useState)();
  const [loading, setLoading] = (0,external_react_.useState)();
  const cancelRef = (0,external_react_.useRef)();
  const inputPathRef = (0,external_react_.useRef)();
  const prevPathRef = (0,external_react_.useRef)();
  ...
  const updateRouter = (0,external_react_.useCallback)((state) => {
    if (typeof state === "function") {
  ...
  const historyEvents = (opt, event = "pushState") => {
    ...
    const historyCallback = () => history[event](opt?.state, "", path);
    changeRouter({ inputPath: path, inputParams: params }, historyCallback);
  };
  const push = (0,external_react_.useCallback)((opt) => historyEvents(opt), []);
  const replace = (0,external_react_.useCallback)((opt) => historyEvents(opt, "replaceState"), []);
  const changeRouter = (0,external_react_.useCallback)(({ inputPath = "", inputParams = {} }, historyCallback) => {
    ...
    new Promise((resolve, reject) => {
      ...
      inputPathRef.current = inputPathRef.current ?? inputPath;
      ...
      historyCallback?.();
      if (inputPath?.split("?")[0] !== prevPathRef.current?.split("?")[0]) {
        resetScroll();
      }
      ...
      if (utils_isAsync(components)) {
        ...
        return promiseFn.then((res2) => {
          ...
          const comps = errMsg === false ? result : errMsg?.timeout ? loadError({ error: { errMsg: `${inputPath} ${errMsg.timeout}` } }) : null;
          if (comps) {
            setLoading(false);
...
/* harmony default export */ const router = (useRouter);
  ...
  const handleClick = (e) => {
    ...
    if (!preventDefault) {
      if (target) {
        ...
        const queryStr = utils_params2str(to?.query);
        const noShap = browserRouter || path.indexOf("#/") > -1 || utils_isUrl(path);
        window?.open(`${noShap ? "" : "#"}${path}${queryStr}`, target);
        return;
      }
      triggerPush();
    }
...
/* harmony default export */ const src_handleLinkClick = (handleLinkClick);

// EXTERNAL MODULE: ../../node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[3].use[1]!../../node_modules/less-loader/dist/cjs.js??ruleSet[1].rules[3].use[2]!../huxy/router/link.less
var router_link = __webpack_require__(267);
...
var link_update = injectStylesIntoStyleTag_default()(router_link/* default */.Z, link_options);
       ...
       /* harmony default export */ const huxy_router_link = (router_link/* default */.Z && router_link/* default.locals */.Z.locals ? router_link/* default.locals */.Z.locals : undefined);
...
/* harmony default export */ const huxy_router_link_0 = (Link);

;// CONCATENATED MODULE: ../huxy/router/useRoute.jsx


const useRoute = () => {
  const [info, setInfo] = (0,external_react_.useState)(routeStore.getState());
  (0,external_react_.useEffect)(() => routeStore.subscribe((result) => setInfo(result)), []);
  return info;
};
/* harmony default export */ const router_useRoute = (useRoute);
...
var __webpack_exports__emitRoute = __webpack_exports__.cb;
var __webpack_exports__getRoute = __webpack_exports__.Bv;
var __webpack_exports__useRoute = __webpack_exports__.yj;
var __webpack_exports__useRouter = __webpack_exports__.tv;
export { __webpack_exports__Link as Link, __webpack_exports__emitRoute as emitRoute, __webpack_exports__getRoute as getRoute, __webpack_exports__useRoute as useRoute, __webpack_exports__useRouter as useRouter };
